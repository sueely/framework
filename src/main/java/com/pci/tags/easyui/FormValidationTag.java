...
import com.pci.util.StringUtil;
	...
	public int doEndTag() throws JspException {
		try {
			...
			if (layout.equals("div")) {
				sb.append("<link rel=\"stylesheet\" href=\""+basePath+"plugins/Validform/css/divfrom.css\" type=\"text/css\"/>");
				if (tabtitle != null)
					sb.append("<script type=\"text/javascript\" src=\""+basePath+"plugins/Validform/js/form.js\"></script>");
			}
			sb.append("<link rel=\"stylesheet\" href=\""+basePath+"plugins/Validform/css/style.css\" type=\"text/css\"/>");
			sb.append("<link rel=\"stylesheet\" href=\""+basePath+"plugins/Validform/css/tablefrom.css\" type=\"text/css\"/>");
			sb.append("<script type=\"text/javascript\" src=\""+basePath+"plugins/Validform/js/Validform_v5.3.1_min.js\"></script>");
			sb.append("<script type=\"text/javascript\" src=\""+basePath+"plugins/Validform/js/Validform_Datatype.js\"></script>");
			sb.append("<script type=\"text/javascript\" src=\""+basePath+"plugins/Validform/js/datatype.js\"></script>");
			if (usePlugin != null) {
				if (usePlugin.indexOf("jqtransform") >= 0) {
					sb.append("<SCRIPT type=\"text/javascript\" src=\""+basePath+"plugins/Validform/plugin/jqtransform/jquery.jqtransform.js\"></SCRIPT>");
					sb.append("<LINK rel=\"stylesheet\" href=\""+basePath+"plugins/Validform/plugin/jqtransform/jqtransform.css\" type=\"text/css\"></LINK>");
				}
				if (usePlugin.indexOf("password") >= 0) {
					sb.append("<SCRIPT type=\"text/javascript\" src=\""+basePath+"plugins/Validform/plugin/passwordStrength/passwordStrength-min.js\"></SCRIPT>");
				}
			}
